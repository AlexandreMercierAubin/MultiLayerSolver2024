...
if settings.Shading
    camlight(ax1,settings.camLightPosition, settings.camLightStyle);
...
if ( settings.PlotEDotHist || settings.PlotDihedralRateHist || settings.PlotEdotVsCurvatureHists )
...
elseif settings.plotFrameTimeHistogram
...
mainFig.Renderer = settings.renderer;
