function [caches] = setupCache(settings, meshes, rigidificators, integrators, comparisons, energyModel, h)
...
cachedAinvString = ['3d/data/cached/', convertStringsToChars(sceneDescriptor), 'Ainv.mat'];
    ...
    if toRecompute
        ...
        for k = 1:comparisons
            ...
            if ( isa(mesh3D, 'AdaptiveMesh3D') && ~isa(integrator, 'xpbdLayer3D'))   
