classdef contactInfo3D < handle
    ...
    properties
        ...
        pointCollider %position of the collision point on the collider
    ...
    methods
        function obj = contactInfo3D( point, normal, tangent, mu, nodeIndices, contactFinderId ,tangent2, phi, contactCompliance)
            %CONTACTINFO Construct an instance of this class
            obj.vertexID = zeros(1,4);
            obj.vertexID(1:numel(nodeIndices)) = nodeIndices;
            obj.point = point;
            obj.normal = normal;
            ...
            if nargin >= 9
                obj.xpbdContactCompliance = contactCompliance;
            end
