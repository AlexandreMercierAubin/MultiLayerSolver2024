function mesh2d = fetchPoly2D(fileName, resetMesh, materials, scale, rotation, settings, enforceMass, massEnforced)
    ...
    mesh2d = loadMeshFromPOLY(readPath, materials, scale, rotation,enforceMass,massEnforced);
