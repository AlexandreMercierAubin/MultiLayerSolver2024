classdef TimingData < handle
    ...
    % TODO: could define constatnts that define each row of the log
    % TODO: could also define text lables that define each row of the log
    % TODO: could add plotting methods in this class, for the basic data or
